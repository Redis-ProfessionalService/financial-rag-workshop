...
If you already downloaded the models in a local file system, set this folder in the notebook via this:
...
In particular, we use `sentence-transformers--all-MiniLM-L6-v2` which we have made it available locally in the `models` folder of this repo.
...
and planning for next action and not just the generation part of the RAG patterns.
